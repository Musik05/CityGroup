...
//         btn.classList.toggle('click', isInBasket);
//         btn.textContent = isInBasket ? 'Узнать больше' : 'Узнать больше';
//     });
// }
...
function createCards(data) {
    data.forEach(card => {
        const { id, img, title, price, adress } = card;
		const cardItem = 
			`
                    ...
                    <div class="card" data-product-id="${id}">
                        ...
                        <div class="card__bottom">
                            ...
                            <a href="/card.html?id=${id}"><button class="card__add">Узнать больше</button></a>
                        </div>
                    </div>
            `
